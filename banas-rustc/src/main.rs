...
use std::{f32, f64, i16, i32, i64, i8, isize, usize};
// also u8, u16, u32, u64,
...
fn main() {
    ...
    let (_f_name, _l_name) = ("Derek", "Banas");
    ...
    println!("PI to Degrees = {}", f64::consts::PI.to_degrees());
    println!("Max 4, 5 = {}", 4f64.max(5f64));
    println!("Min 4, 5 = {}", 4f64.min(5f64));

    // sin, cos, tan, asin, acos, atan, atan2, sinh,
    // cosh, tanh
    println!("Sin 3.14 = {}", f64::consts::PI.sin());
    ...
    let _count = rand_string.chars().count();
    ...
    'outer: loop {
        ...
        loop {
            ...
            let guess: Option<i32> = input.ok().and_then(|_| line.trim().parse().ok());
